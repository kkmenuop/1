...
function vu102.LoadLibrary(pu603)
    ...
    lf_178:AddDiscordInvite({
        Name = "Kakah Menu | Community",
        Description = "Acesse O grupo dos Clientes",
        Logo = "rbxassetid://17382040552",
        Invite = "https://discord.gg/Gvy2cGxzK5"
    })
    lf_178:AddSection("")
    lf_178:AddParagraph({
        "Mentions:
 Honorable Mention: Souza
 Honorable Mention 2: DiegoSpash"
    })
